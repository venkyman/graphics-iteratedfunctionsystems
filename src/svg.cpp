...
void SVGParser::parseSVG( XMLElement* xml, SVG* svg ) {
  ...
  while( elem ) {
    ...
    } else if( elementType == "fractal" ) {
      
      Fractal* fractal = new Fractal();
      parseElement( elem, fractal );
      parseFractal( elem, fractal );
      svg->elements.push_back( fractal );
...
void SVGParser::parseFractal( XMLElement* xml, Fractal* fractal ) {
  ...
  while (transformationElement) {
    fractal->transformations.push_back(
               Transformation(transformationElement->FloatAttribute("prob"),
                              transformationElement->FloatAttribute("a"),
                              transformationElement->FloatAttribute("b"),
                              transformationElement->FloatAttribute("c"),
                              transformationElement->FloatAttribute("d"),
                              transformationElement->FloatAttribute("e"),
                              transformationElement->FloatAttribute("f")));
